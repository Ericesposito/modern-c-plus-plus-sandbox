...
NeighborVehiclesType init_vehicles()
{
    ...
    init_vehicle(vehicles.vehicles_center_lane[1], 3, 80.0F, -30.0F, LaneAssociationType::CENTER);
    init_vehicle(vehicles.vehicles_right_lane[0], 4, 80.0F, 70.0F, LaneAssociationType::RIGHT);
    init_vehicle(vehicles.vehicles_right_lane[1], 5, 80.0F, -40.0F, LaneAssociationType::RIGHT);
